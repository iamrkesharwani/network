...
const VideoEditForm = forwardRef<EditFormHandle, VideoEditFormProps>(
  (
    { mode, videoId, thumbnailUrl, captions, initialValues, onSuccess },
    ref
  ) => {
...
VideoEditForm.displayName = 'VideoEditForm';
