...
const ShortEditForm = forwardRef<EditFormHandle, ShortEditFormProps>(
  ({ mode, shortId, thumbnailUrl, initialValues, onSuccess }, ref) => {
...
ShortEditForm.displayName = 'ShortEditForm';
